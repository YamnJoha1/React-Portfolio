    ...
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      ...
      >
        <div className="relative w-full h-[230px]">
          ...
          <div className="absolute flex justify-between top-0 left-0 w-full flex-row-reverse">
  ...
  return (
    <>
      ...
      <div className="w-full flex">
        ...
        >
          Following projects showcases my skills and experiance through real-world example of my work.
          Each project is briefly described with links to code repositories and live demos in it.
          It reflects my ability to solve complex proplemsm, work with different tchnologies, and
          mange projects effectively.
        </motion.p>
      </div>
...
export default SectionWarpper(Works, "projects")